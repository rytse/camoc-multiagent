...
from rl_agent.ma_ppo import MA_PPO
...
model = MA_PPO(MlpPolicy, env,
            verbose=3, gamma=0.95, n_steps=256,
...
model.save("./policies/swarmcover_mappo_policy")

# Rendering
env = swarm_cover_v1.env()
env = ss.frame_stack_v1(env, 3)
model = MA_PPO.load("./policies/swarmcover_mappo_policy")
