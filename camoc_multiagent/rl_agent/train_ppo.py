...
from rl_agent.trainutils.exp_manager import ExperimentManager
from rl_agent.trainutils.utils import ALGOS, StoreDict

seaborn.set()

def ppo_factory(**kwargs):
    return PPO(**kwargs)

def train_ppo(env_train, env_eval, env_name):
